import { A as AstroError, q as ExpectedImageOptions, E as ExpectedImage, t as InvalidImageService, c as createAstro, d as createComponent, v as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, _ as __astro_tag_component__, F as Fragment, p as createVNode } from './astro_rr27FtTQ.mjs';
import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS } from './astro/assets-service_GueMNxoA.mjs';
import '@astrojs/internal-helpers/path';
import 'clsx';
import { j as $$HeaderLink } from './pages/__j0pHW8U4.mjs';

async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_GueMNxoA.mjs'
    ).then(n => n.s).catch((e) => {
